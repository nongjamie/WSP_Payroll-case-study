...
public class AddHourlyEmployeeTransactionTest {
	...
	public void testAddHourlyEmployee() {
		int employeeId = 1;
		Transaction addEmployeeTransaction = new AddHourlyEmployeeTransaction(employeeId, "Steve", "Home", 20.0);
		...
		assertThat(hourlyClassification.getHourlyRate(), is(closeTo(20.0, FLOAT_ACCURACY)));
